...
assembler curriculum now covers startup, input, GRAM and tile maps, scrolling,
HUD text, state flow, randomness, PSG music/effects, VBLANK budgeting, and
production cartridge layout:
